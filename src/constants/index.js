...
export const diveWorldCourses = [
  ...
  },
  {
    ...
    maxDepth: "40 m / 130 ft",
    otherConditions: "Wymagania do otrzymania certyfikatu:",
    other: "certyfikat Open Water Diver, co najmniej 24 zalogowane nurkowania",
    duration: "Czas trwania kursu:",
    durationCondition: 2,
    otherImgs: xrf1,
  },
  ...
  },
  {
    ...
    description: "Sprawdź szczegóły",
    content:
      "Program ten zapewnia wiedzę i umiejętności do samodzielnego planowania i przeprowadzenia nurkowań wrakowych z ograniczoną penetracją w granicach światła dziennego do maksymalnej głębokości 40m z wykorzystaniem sprzętu i procedur wrakowych z partnerem o równych lub o wyższych uprawnieniach.",
